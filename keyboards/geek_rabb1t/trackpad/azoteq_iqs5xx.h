...
typedef struct {
    azoteq_iqs5xx_relative_xy_t      absolute_x;
    azoteq_iqs5xx_relative_xy_t      absolute_y;
    azoteq_iqs5xx_relative_xy_t      touch_strength;
    uint8_t                          touch_area;
} azoteq_iqs5xx_finger_t;
...
typedef struct {
    ...
    azoteq_iqs5xx_finger_t           finger_1;
    azoteq_iqs5xx_finger_t           finger_2;
    azoteq_iqs5xx_finger_t           finger_3;
    azoteq_iqs5xx_finger_t           finger_4;
    azoteq_iqs5xx_finger_t           finger_5;
} azoteq_iqs5xx_base_data_t;

_Static_assert(sizeof(azoteq_iqs5xx_base_data_t) == 45, "azoteq_iqs5xx_basic_report_t should be 45 bytes");
